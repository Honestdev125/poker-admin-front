...
export function getColumnsOrder() {
    return async () => {
        try {
            const response = await axios.get('/kanban/columns-order');
...
export function getComments() {
    return async () => {
        try {
            const response = await axios.get('/kanban/comments');
...
export function getProfiles() {
    return async () => {
        try {
            const response = await axios.get('/kanban/profiles');
...
export function getItems() {
    return async () => {
        try {
            const response = await axios.get('/kanban/items');
...
export function getUserStory() {
    return async () => {
        try {
            const response = await axios.get('/kanban/userstory');
...
export function getUserStoryOrder() {
    return async () => {
        try {
            const response = await axios.get('/kanban/userstory-order');
...
export function addColumn(column, columns, columnsOrder) {
    return async () => {
        try {
            const response = await axios.post('/kanban/add-column', { column, columns, columnsOrder });
...
export function editColumn(column, columns) {
    return async () => {
        try {
            const response = await axios.post('/kanban/edit-column', { column, columns });
...
export function updateColumnOrder(columnsOrder) {
    return async () => {
        try {
            const response = await axios.post('/kanban/update-column-order', { columnsOrder });
...
export function deleteColumn(columnId, columnsOrder, columns) {
    return async () => {
        try {
            const response = await axios.post('/kanban/delete-column', { columnId, columnsOrder, columns });
...
export function addItem(columnId, columns, item, items, storyId, userStory) {
    return async () => {
        try {
            const response = await axios.post('/kanban/add-item', { columnId, columns, item, items, storyId, userStory });
...
export function editItem(columnId, columns, item, items, storyId, userStory) {
    return async () => {
        try {
            const response = await axios.post('/kanban/edit-item', { items, item, userStory, storyId, columns, columnId });
...
export function updateColumnItemOrder(columns) {
    return async () => {
        try {
            const response = await axios.post('/kanban/update-item-order', { columns });
...
export function selectItem(selectedItem) {
    return async () => {
        try {
            const response = await axios.post('/kanban/select-item', { selectedItem });
...
export function addItemComment(itemId, comment, items, comments) {
    return async () => {
        try {
            const response = await axios.post('/kanban/add-item-comment', { items, itemId, comment, comments });
...
export function deleteItem(itemId, items, columns, userStory) {
    return async () => {
        try {
            const response = await axios.post('/kanban/delete-item', { columns, itemId, userStory, items });
...
export function addStory(story, userStory, userStoryOrder) {
    return async () => {
        try {
            const response = await axios.post('/kanban/add-story', { userStory, story, userStoryOrder });
...
export function editStory(story, userStory) {
    return async () => {
        try {
            const response = await axios.post('/kanban/edit-story', { userStory, story });
...
export function updateStoryOrder(userStoryOrder) {
    return async () => {
        try {
            const response = await axios.post('/kanban/update-story-order', { userStoryOrder });
...
export function updateStoryItemOrder(userStory) {
    return async () => {
        try {
            const response = await axios.post('/kanban/update-storyitem-order', { userStory });
...
export function addStoryComment(storyId, comment, comments, userStory) {
    return async () => {
        try {
            const response = await axios.post('/kanban/add-story-comment', { userStory, storyId, comment, comments });
...
export function deleteStory(storyId, userStory, userStoryOrder) {
    return async () => {
        try {
            const response = await axios.post('/kanban/delete-story', { userStory, storyId, userStoryOrder });
